...
public class MainActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    PackageHunter.getInstance().getInstalledPackages(this);
  ...
  private ArrayList<String> getStringList(String querytext) {
    ArrayList<PkgInfo> pkglist =
        PackageHunter.getInstance().getListOfPackages(getApplicationContext(), querytext);
    ArrayList<String> dataStringlist = new ArrayList<>();
    for (PkgInfo pkgInfo : pkglist) {
      dataStringlist.add("App Name : "
          + pkgInfo.getApp_name()
          + "\nPackage Name : "
          + pkgInfo.getPkg_name()
          + "\nApp Name : ");
